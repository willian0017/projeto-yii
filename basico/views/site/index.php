...
<div class="site-index">
    ...
    <div>
        <p class="info">Tenha um controle maior sobre os condomínios que você administra. <br/> Acesse a área de <span class="blue">inquilinos</span>, <span class="blue">unidades</span> e <span class="blue">unidades</span>.
        </p>
    </div>
</div>
<style>
